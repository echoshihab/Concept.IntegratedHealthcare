...
namespace Concept.PatientRecordSystem.Migrations
{
    ...
    [Migration("20241008195334_configureRequesterServiceRequestForeignKey")]
    partial class configureRequesterServiceRequestForeignKey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Concept.PatientRecordSystem.Persistence.Models.Modality", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Concept.PatientRecordSystem.Persistence.Models.ProcedureDetail", b =>
                {
                    b.HasOne("Concept.PatientRecordSystem.Persistence.Models.Modality", "Modality")
                        .WithMany()
